...
- Students can plan the LEO→GEO transfer: raise apogee (~2,400 m/s), then circularize
  (~1,460 m/s), ≈ 3,860 m/s total against the 4,000 m/s budget — and explain why circularizing
...
- *Beats* — (1) Plan before you fly: vis-viva gives each burn's Δv; the logbook's running total
  ...
  against a 4,000 m/s tank, so sloppy hand-flying eats the whole margin. (3) The graduation flight
