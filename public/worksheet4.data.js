...
const WORKSHEET = {
  ...
  tutorial: [
    ...
    'A <b>tangential</b> burn (prograde = speed up, retrograde = slow down) points along your direction of travel. It does real work on the orbit and efficiently raises or lowers the <b>opposite</b> side. A <b>radial</b> burn (straight toward or away from Earth) does almost no work — it just tilts the ellipse. In fact, shoving hard "up" swings the far side <b>down</b>, and can drop it into the Earth.',
