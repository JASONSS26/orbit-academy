...
const EXAM = [
  ...
  { mod:'Module 8 · Lunar Transfers',
    ...
    a:1, why:'The trans-lunar coast takes several days, during which the Moon moves on — roughly 50° around its orbit (about a seventh of the way) over a ~3.8-day transfer; you launch toward the Moon’s future position, not its current one.',
