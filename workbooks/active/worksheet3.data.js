...
const WORKSHEET = {
  ...
  tasks: [
    ...
    { id:'a3', title:'The two orientation angles (against the stars)',
      ...
      observe:'RAAN swivels the whole tilted plane around the vertical; argument of perigee rotates the ellipse <i>within</i> that plane, moving the green (perigee) and red (apogee) markers. The stars stay fixed so both rotations are visible.',
      think:[
