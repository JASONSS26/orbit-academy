  ...
  tasks: [
    ...
    { id:'d1', title:'Release a cluster — watch it scatter',
      teach:[
        ...
        'The <b>fan release</b> lets you see this directly. Its mixed fan drops <b>seven</b> objects from one spot — but only <b>three</b> are launched almost the same: a near-identical <b>cluster</b>, and that cluster is the chaos demonstration. The other four are deliberate extremes for contrast: two lean retrograde and peel inward, and two aim at the Moon. The tool integrates their real motion live under Earth + Moon gravity.',
      ],
      predict:'Three of the seven objects will be launched within a fraction of a percent of each other. Do you think that near-identical cluster will stay together, or spread apart — and if it spreads, how quickly: hours, days, or years?',
      do:[
        'Open the <b>Fan release</b> scenario. Choose a release spot (try <b>at L1</b>) and a small <b>speed spread</b> (~0.4%), then press <b>▶ release</b>.',
        'Let the four deliberate extremes go their own ways and keep your eye on the near-identical <b>cluster</b> — watch the “current scatter” readout climb as it blows apart. Then try again from a <b>different spot</b> (at L2, or far out) and compare how fast it diverges.',
        'Tighten the spread to 0.1% and release again — does starting closer together delay the blow-up much?',
      ],
      observe:'the near-identical cluster holds together briefly, then scatters — and once scattered, its members’ paths are effectively uncorrelated (the four extreme launches were never together to begin with).',
      think:[
    ...
    { id:'d1b', title:'Lunar scatter — slingshots and escape',
      ...
      do:[
        ...
        'Watch the <b>“unbound so far”</b> readout. Note when objects escape (a green banner announces the first; after that, the counter keeps score) and roughly how long after release it happened.',
