...
const WORKSHEET = {
  ...
  tasks: [
    ...
    { id:'b2', title:'Burn 2 — circularize at GEO (log the Δv)',
      ...
      do:'In the planner’s <b>STEP 2</b>, dial "Your Δv₂" with the ▲/▼ digit steppers until "your new speed" matches the circular speed shown (~3.08 km/s). Record the Δv in logbook row 2, then write the MISSION TOTAL and compare to the 4,000 m/s budget.',
    ...
    { id:'d2', title:'LOI — brake BACKWARDS or sling right past',
      ...
      do:'Dial <b>Δv₂</b> to ~900 m/s (the planner flies it BACKWARDS automatically), then press <b>▶ GO — run sim</b> and watch the prediction. Nudge Δv₁ (±1–2 m/s), the lead angle, and Δv₂ until the verdict reads <b>✔ LUNAR CAPTURE predicted</b>. Log Δv₂ and your total against the 4,200 m/s budget.',
      ...
      think:[
        ...
        'Where did your total land against 4,200 m/s, and how much margin is left for trims?',
      ],
  ...
  summary: [
    ...
    'You <b>fly the plan</b> by holding the right thruster to each logged Δv at the <b>BURN NOW</b> cue, using the <b>ILS-style</b> localizer (on-track?) and speed dial (on-speed?) to stay on the planned trajectory. Winning means <b>holding the target box for a full orbit</b>, near the target satellite — not just touching it.',
    'The lunar graduation flight re-aims the same skills at a <b>moving</b> target: <b>lead the Moon</b> (~120°), aim your apogee just <b>past</b> it (~395,000 km — dead-center is a collision), burn <b>TLI</b> (~3,090 m/s prograde), coast ~4 days, then <b>LOI</b> — a ~900 m/s <b>BACKWARDS brake</b> at closest approach so the Moon’s gravity can capture you. Budget 4,200 m/s.',
  ],
